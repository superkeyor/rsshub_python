...
sudo docker stop --force rsshub_python && sudo docker rm rsshub_python && sudo docker run -d --rm --name rsshub_python -p 11201:5000 superkeyor/rsshub_python:latest
echo ""
flask run --host=0.0.0.0 --port=1201
